...
object GithubServerConfig {
  ...
  ) extends _root_.izumi.idealingua.runtime.IRTConversions[GithubServerConfig]
  
  /**
    * conversion:structural-structure-upcast
    */
  implicit object Copy_GithubServerConfig_to_GithubClientConfig_StructuralUpcast_Reliable_1582467299 extends _root_.izumi.idealingua.runtime.IRTCast[GithubServerConfig, GithubClientConfig] {
